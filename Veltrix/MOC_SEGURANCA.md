...
Mapa dos limites de seguranca do Veltrix.
...
- Microfone: áudio não é gravado, guardado, logado nem enviado ao Veltrix ou
...
- **Cancelamento remoto não comprovável**: após um timeout de transporte, o
  Veltrix fecha a conexão local, mas não há prova de que a geração remota
