# Veltrix V4.0.0 — Comandos PowerShell
...
git tag -a v4.0.0 -m "Veltrix V4 approved - improved chat interface"
```
...
ea295c3 (tag: v2.0.0) feat: approve Veltrix V2 multi-provider
working tree clean
