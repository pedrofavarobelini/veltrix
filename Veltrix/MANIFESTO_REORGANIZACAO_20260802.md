...
O vault canônico do Veltrix está em `C:\Projetos\pedrocore-ia\Veltrix`.
...
- o validador canônico `app.modules.docs_graph` passou a usar `Veltrix`
  como raiz e `Veltrix/MOC_VELTRIX.md` como MOC principal.
