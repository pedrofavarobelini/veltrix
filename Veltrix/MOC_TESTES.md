...
- Consumer Structa: `test_structa_consumer_onboarding.py` — 15 casos offline de project context, identidade, provider/task policy, defaults e regressões FinGuard/Veltrix.
