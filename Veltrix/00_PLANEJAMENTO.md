# Veltrix — Planejamento Geral

## Objetivo

O Veltrix é uma API/assistente pessoal de inteligência artificial para testar respostas, qualidade, contexto, escrita, comportamento e formato das respostas de IA.
...
1. Veltrix fica em `C:\Projetos\pedrocore-ia`.
2. FinGuard fica separado em `C:\Projetos\FinGuard`.
3. Nenhum comando do Veltrix deve ser executado dentro do FinGuard.
