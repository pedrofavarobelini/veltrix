...
Aplicar a logo oficial escolhida para o Veltrix sem alterar o design aprovado da V5.
...
A logo foi aplicada como imagem estática importada no React, mantendo o texto `Veltrix` renderizado pela interface. Isso evita usar uma arte grande com texto rasterizado dentro da UI e mantém melhor responsividade.
