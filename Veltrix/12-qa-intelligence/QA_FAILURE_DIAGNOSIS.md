...
> Nota DOCFIX: este caso de uso foi implementado no lado Veltrix como heurística textual local em `POST /api/orchestrate` e `/api/chat`, usando `task_type="qa_failure_diagnosis"`. Não é IA real, não lê o FinGuard e não executa testes.
