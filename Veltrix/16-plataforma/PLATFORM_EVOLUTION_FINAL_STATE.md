...
```text
PedroCore → Veltrix (rename global) — concluído no fechamento final
...
Porta padronizada para agentes externos conversarem com o Veltrix e entre
...
**Custo/risco:** exige cooperação do executor, que é externo ao Veltrix.
