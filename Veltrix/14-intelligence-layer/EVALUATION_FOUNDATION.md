...
**Melhoria sem avaliação é perigosa.** Qualquer evolução do Veltrix rumo a inteligência própria (memória técnica, provider local, prompts melhores) precisa de uma forma de medir se um plano/resposta é seguro, coerente e compatível com as políticas — antes de confiar nele.
