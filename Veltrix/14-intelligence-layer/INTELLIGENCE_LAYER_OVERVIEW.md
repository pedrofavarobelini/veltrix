...
A Intelligence Layer é a fundação do Veltrix como **núcleo de inteligência operacional do ecossistema**. É uma camada determinística que prepara a decisão cognitiva/operacional ANTES do provider:
...
- **Não é um modelo de IA treinado.** O Veltrix continua sendo orquestrador multi-provider.
