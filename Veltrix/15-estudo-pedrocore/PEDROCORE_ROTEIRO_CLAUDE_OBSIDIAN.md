...
```text
Vou te enviar documentos do Veltrix. Quero que voce estude como um revisor tecnico frio. Separe o que esta implementado, o que e futuro, o que e limite de seguranca e o que seria risco se fosse confundido.
```
...
```text
Crie um mapa mental hierarquico do Veltrix com arquitetura, rotas, modulos, providers, seguranca, memoria, eval harness e integracao futura com FinGuard.
```
...
2. Use links para MOCs: `[[MOC_VELTRIX]]`, `[[MOC_ARQUITETURA]]`, `[[MOC_TESTES]]`.
...
- "Veltrix e um orquestrador seguro de IA, nao um LLM proprio."
