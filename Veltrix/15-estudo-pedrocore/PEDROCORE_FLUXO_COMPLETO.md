...
O consumidor nao deve chamar provider externo diretamente. O Veltrix e a camada de controle.
...
Quando `context_from_memory=true`, o Veltrix tenta anexar um snapshot tecnico do projeto. Por default a persistencia esta off, nada e consultado e `memory_used=false`. Se desabilitada, retorna warning e segue sem inventar dados.
