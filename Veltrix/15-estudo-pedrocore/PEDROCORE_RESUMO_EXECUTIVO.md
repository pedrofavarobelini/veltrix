...
Veltrix e um core/orquestrador local de IA para o ecossistema de projetos do Pedro. Ele centraliza chamadas, politicas, contexto de projeto, fallback, avaliacao, memoria tecnica controlada e rotas de assistente, para que sistemas consumidores nao precisem falar diretamente com providers externos.
...
2. Planejar integracao real do Assistente FinGuard via Veltrix como frente separada.
