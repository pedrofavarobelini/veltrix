...
execução, o Veltrix valida no catálogo explícito:
...
→ Veltrix seleciona Gemini (AUTO_REAL_PROVIDER_CANDIDATES, inalterado)
→ Veltrix seleciona o modelo default autorizado do Gemini
