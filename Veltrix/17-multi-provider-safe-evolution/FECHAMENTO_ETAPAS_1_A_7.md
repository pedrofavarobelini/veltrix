# Veltrix Multi-Provider Safe Evolution — Fechamento das Etapas 1–7
...
Depois das Etapas 1–7, o Veltrix possui catálogo de providers/modelos,
...
- Veltrix permanece o orquestrador central do ecossistema.
- FinGuard chama somente o Veltrix; não recebe chaves de provider.
...
→ provider=auto
→ model ausente
→ Veltrix controla identidade, policy, provider, modelo e fallback
```
