# Veltrix — Elyra Onboarding V1 Textual
...
O Veltrix passou a reconhecer Elyra legitimamente no pipeline nativo. Não
foi criada arquitetura paralela, identidade falsa nem permissão herdada de
Veltrix, FinGuard ou Structa.
...
- respostas 401 legadas não ganham `correlation_id=null`; o campo só aparece
  quando fornecido;
- regras FinGuard, Structa e Veltrix permaneceram independentes;
