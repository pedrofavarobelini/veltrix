# ADR — Veltrix Universal Contracts V1
...
O que ficou de fora foi a outra fronteira: a que separa **o Veltrix dos seus
consumidores**.
...
aprendizado do Veltrix, e o Learning Plane inteiro vale o que vale a boa-fé
...
A regra não é "nome de projeto é proibido" — seria impossível, o Veltrix
...
- As mensagens de bloqueio deixaram de nomear consumidores, o que evitava
  revelar a terceiros quais sistemas o Veltrix conhece.
...
derivado pelo Veltrix, que pode mudar de opinião sem pedir nada ao produtor.
