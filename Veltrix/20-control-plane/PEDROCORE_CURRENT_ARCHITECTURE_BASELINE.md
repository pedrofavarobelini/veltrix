# Veltrix — Current Architecture Baseline
...
├── Veltrix/     vault documental Obsidian canônico (155 documentos)
├── README.md
└── VERSION.md
```
...
segurança — um adapter interno exigiria que o Veltrix alcançasse a base do
