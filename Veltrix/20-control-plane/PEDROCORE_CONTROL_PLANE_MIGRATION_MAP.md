# Veltrix — Control Plane Migration Map
...
| Módulo | Ação | Nota |
|---|---|---|
| `training_data` | KEEP | 2.642 loc; Dataset Foundation exclusiva do Veltrix |
...
| `Veltrix/20-control-plane/PEDROCORE_CURRENT_ARCHITECTURE_BASELINE.md` | fotografia factual da Era 1 |
| `Veltrix/20-control-plane/ADR_PEDROCORE_AI_RUNTIME_LEARNING_CONTROL_PLANE.md` | decisão arquitetural |
| `Veltrix/20-control-plane/PEDROCORE_CONTROL_PLANE_MIGRATION_MAP.md` | este mapa |
