...
Resposta: Modulo que define limites por sistema consumidor, como PedroCore ou FinGuard.

Pergunta: Como FinGuard e tratado?
Resposta: Como consumidor read-only; PedroCore nao le nem altera o repositorio FinGuard.
...
Pergunta: O PedroCore ja esta integrado ao Assistente FinGuard real?
Resposta: Nao. Essa integracao e frente futura separada.

Pergunta: O PedroCore baixa modelo local?
Resposta: Nao.

Pergunta: O PedroCore instala Ollama, llama.cpp ou LM Studio?
Resposta: Nao.
