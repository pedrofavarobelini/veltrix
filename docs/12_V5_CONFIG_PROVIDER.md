...
Adicionar uma tela própria para configurar providers no frontend React do PedroCore IA, permitindo escolher provider, modelo, modo e prompt base sem expor chaves de API no navegador.
