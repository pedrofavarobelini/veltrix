...
modelo, não recebe nem repassa chaves, e o PedroCore resolve identidade,
...
**130 documentos** preexistentes no vault `PedroCore IA/`, mais `README.md` e
...
- `PedroCore IA/09_STATUS_ATUAL.md` — nova seção canônica; **proibição de
  alterar `apps/web` levantada** e explicada; "frontend preservado sem
  alteração" corrigido.
- `PedroCore IA/08_CHANGELOG.md` — entrada da frente + nota de convenção de
  caminhos `docs/`.
- `PedroCore IA/03-versoes/ROADMAP.md` — concluído movido para fora das
  pendências.
- `PedroCore IA/MOC_PEDROCORE_IA.md`, `MOC_TESTES.md`, `MOC_SEGURANCA.md`,
...
- [[09_STATUS_ATUAL]] · [[08_CHANGELOG]] · [[MOC_PEDROCORE_IA]]
