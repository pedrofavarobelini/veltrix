...
1. Instalar manualmente um backend local (Ollama, llama.cpp, LM Studio ou compatível OpenAI local) — **nenhum download/instalação automática acontece**; nenhum modelo é baixado pelo PedroCore.
