# ADR — PedroCore AI Runtime & Learning Control Plane
...
O PedroCore cresceu como um modular monolith FastAPI com 40 módulos e cerca de
...
O problema é que o PedroCore acumulou **duas responsabilidades de natureza
...
### 1. O PedroCore passa a ter dois planos declarados
...
**A Dataset Foundation é responsabilidade exclusiva do PedroCore.**
...
- o PedroCore **não alcança a base de dados de nenhum consumidor**. Para
