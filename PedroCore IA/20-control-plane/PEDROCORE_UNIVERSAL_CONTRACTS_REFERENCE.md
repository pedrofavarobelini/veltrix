# PedroCore Universal Contracts V1 — Referência
...
Universal Contract
   ↓
PedroCore  →  validação  →  Operational Source
                                  ↓
...
nomeia um consumidor específico revela a terceiros quais sistemas o PedroCore
