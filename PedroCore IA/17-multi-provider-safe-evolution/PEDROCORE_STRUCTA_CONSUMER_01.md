# PedroCore — onboarding seguro do consumer Structa
...
Claude, DeepSeek, Grok ou providers futuros. As regras FinGuard e PedroCore
...
Cinco arquivos preexistentes sob `PedroCore IA/.obsidian/` foram classificados
...
O PedroCore já aceita `uvicorn ... --port <porta-livre>`. A futura Etapa 13
