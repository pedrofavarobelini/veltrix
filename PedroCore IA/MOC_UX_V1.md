# MOC UX V1 — Interface pública do PedroCore

Mapa das frentes `PEDROCORE-V1-FINAL-CLOSURE` e `PEDROCORE-V1-FINAL-UI-FIX`,
que fecharam a interface pública do PedroCore IA: composer único, Configurações
...
Voltar para a entrada do vault: [[MOC_PEDROCORE_IA]].
